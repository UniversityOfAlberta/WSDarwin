	...
	echo
		"<div id=\"compareB\" class=\"compareB\">
			...
			<div class='compareOptions'>
				<input type='radio' class='diffTypeJava' name='diffType' id='diff_type_0' checked>java</input>
				<input type='radio' class='diffTypeText' name='diffType' id='diff_type_1'>text</input>
			</div>
